...
\emph{Statistics} is a branch of Mathematics that deals with data collection, analysis an interpretation. 
\end{definition}

Statistics is essential in any scientific or technical discipline which require data handling, especially with large
volumes of data, such as Physics, Chemistry, Medicine and Health Sciences, but also in Economics, Psychology or Social
Sciences.
  
But, 
\begin{center}
\alert{\emph{Why is necessary Statistics?}}
\end{center}
\end{frame}
...
\begin{center}
\alert{\emph{How much individuals are required to sample to have an approximate but enough knowledge of the
population?}}
\end{center}
...
\includegraphics[scale=0.45]{img/introduction/sample_windmill1}
...
\includegraphics[scale=0.45]{img/introduction/sample_windmill2}
...
\includegraphics[scale=0.45]{img/introduction/sample_windmill3}
...
\begin{center}
\includegraphics[scale=0.5]{img/introduction/reasoning_types}
\end{center}
\end{frame}
...
\end{definition}
\begin{center}
\includegraphics[scale=0.5]{img/introduction/sampling}
\end{center}
...
%---------------------------------------------------------------------slide----
\begin{frame}
\frametitle{Statistical variables}
...
\begin{center}
\includegraphics[scale=0.5]{img/introduction/statistical_variables}
\end{center}
\end{frame}
...
\begin{itemize}
\item \structure{Qualitative variables or attributes:} They measure a non numeric quality. 
They can be:
\begin{itemize}
...
\begin{frame}
\frametitle{Types of statistical variables}
\framesubtible{Choosing the appropriate variable}
...
\begin{center}
\input{img/introduction/statistical_cycle}
\end{center}
\end{frame}
