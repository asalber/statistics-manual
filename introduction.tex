...
The role of Statistics is to extract information from data in order to take decisions.  

\begin{center}
\input{img/introduction/statistics_purpose}
\end{center}

That is why Statistics is essential in any scientific or technical discipline which require data handling, especially
with large volumes of data, such as Physics, Chemistry, Medicine and Health Sciences, but also in Economics, Psychology or Social
Sciences.
...
\frametitle{Types of statistical variables}
\begin{center}
\input{img/introduction/variable_types}
\end{center}
\end{frame}
