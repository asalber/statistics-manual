...
\input{img/introduction/types_reasoning}
\end{center}
\end{frame}
...
\input{img/introduction/sampling}
\end{center}
...
They can be:
\begin{itemize}
\item \structure{Nominal:} There is no natural order between its categories.\\
Example: The eyes or hair colour. 
\item \structure{Ordinal:} There is a natural order between its categories. \\
