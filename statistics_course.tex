...
%\documentclass[mathserif,profesionalfont,10pt,svgnames,red,xcolor=table]{beamer}
% ARTICLE VERSION
...
\usepackage{textcomp}
\usepackage{tikz}
\usetikzlibrary{external,arrows,calc,shapes,shapes.arrows,positioning,snakes,decorations.pathreplacing}
%\tikzexternalize[prefix=img/]
% \tikzset{external/system call={pdflatex \tikzexternalcheckshellescape -halt-on-error -interaction=batchmode -jobname
% "\image" "\texsource"}}
...
\pdfinfo{
   /Author (Alfredo Sanchez Alberca)
   /Title  (Elementary Statistics Manual) 
   /Subject (Statistics)
   /Keywords (Statistics; Data analysis; Descriptive Statistics; Inferential Statistics)
}
...
%---------------------------------------------------------------------cover----
\mode<article>{\title{\textcolor{color1}{\Huge Elementary Statistics Course}}}
\mode<presentation>{\title{Elementary Statistics Course}}
\mode<presentation>{
\author{\texorpdfstring{Alfredo Sánchez Alberca \\ \href{mailto:asalber@ceu.es}{asalber@ceu.es}}{Alfredo
Sánchez Alberca}} 
}
\mode<article>{\author{Alfredo Sánchez Alberca \\ \href{mailto:asalber@ceu.es}{asalber@ceu.es}}}
\mode<presentation>{\institute[USP CEU]{\includegraphics[scale=0.2]{img/logo_uspceu}}}
\date{\mode<article>{\includegraphics[scale=0.2]{img/logo_uspceu}\\[1cm] }
%Curso 2012-2013\\ 
...
%---------------------------------------------------------------------slide----
\begin{frame}
\mode<presentation>{\frametitle{License \includegraphics[scale=0.06]{img/cc-logo}}}
\mode<article>{\null \vfill \noindent \textbf{\Large License} \includegraphics[scale=0.06]{img/cc-logo} \medskip \hrule
depth 3pt \smallskip}
\input{license}
