...
\setbeamertemplate{itemize item}{\smallsize\raise1.25pt\hbox{\donotcoloroutermaths$\blacktriangleright$}}  %to set
% the symbol size of first level items
\setbeamertemplate{itemize subitem}{\smallsize\raise1.25pt\hbox{\donotcoloroutermaths$\blacktriangleright$}}  %to set
% the symbol size of second level items
\setbeamertemplate{itemize subsubitem}{\smallsize\raise1.25pt\hbox{\donotcoloroutermaths$\blacktriangleright$}}  %to
...
\definecolor{color2}{rgb}{0.28,0.46,1}
...
%---------------------------------------------------------------------cover----
\mode<article>{\title{\Huge \ssfamily Elementary Statistics Course}}
