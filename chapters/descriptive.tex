...
Given a sample of $n$ values of a variable $X$, for every value $x_i$ of the variable we define 
\begin{itemize}
...
Assume that a student wants to calculate a representative measure of his/her performance in a course. 
...
In this case it is better to use the weighted mean, using the credits as the
...
In contrast, when variance or the standard deviation are high, the sample data are far from the mean, and the mean does not represent so well. 
\begin{center}
\begin{tabular}{lcl}
...
The \emph{sample coefficient of variation} of a variable $X$ is the quotient between the sample standard deviation and the absolute value of the sample mean.
\[
cv = \frac{s}{|\bar x|}
\]
\end{definition}
...
It measures the symmetry of the distribution, that is, how many values in the
...
%---------------------------------------------------------------------slide----
\begin{frame}
\frametitle{Right-skewed distribution}
...
%---------------------------------------------------------------------slide----
\begin{frame}
\frametitle{Left-skewed distribution}
\framesubtitle{Age of dead}
\begin{center}
...
%---------------------------------------------------------------------slide----
\begin{frame}
\frametitle{Bimodal distribution}
