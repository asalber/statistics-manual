...
\begin{itemize}
\item \highlight{Absolute frequency $n_i$}: The number of times that value $x_i$ appears in the sample.
\item \highlight{Relative frequency $f_i$}: The proportion of times that value $x_i$ appears in the sample.
\[
f_i = \frac{n_i}{n}
\]
\item \highlight{Cumulative absolute frequency $N_i$}: The number of values in the sample less than or equal to
$x_i$.
\[
N_i = n_1 + \cdots + n_i
\]
\item \highlight{Cumulative relative frequency $F_i$}: The proportion of values in the sample less than or equal to
$x_i$.
\[
F_i = \frac{N_i}{n}
\]
...
A \highlight{bar chart} consists of a set of bars, one for every value or category of the variable, plotted on a
coordinate system.
...
\end{frame}
\mode<article>{
The cumulative frequency polygon (for absolute or relative frequencies) is known as \textbf{ogive}.
...
A \highlight{pie chart} consists of a circle divided in slices, one for every value or category of the variable. 
Each slice is called a \highlight{sector} and its angle or area is proportional to the frequency of the corresponding
value or category. 
...
\begin{center}
\tikzsetnextfilename{descriptive/right_skewed_distribution_example}
\scalebox{0.6}{\input{img/descriptive/right_skewed_distribution_example}}
\end{center} 
\end{frame}
...
\begin{center}
\tikzsetnextfilename{descriptive/left_skewed_distribution_example}
\scalebox{0.6}{\input{img/descriptive/left_skewed_distribution_example}}
\end{center} 
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
  \tikzsetnextfilename{descriptive/waiting_time_distribution_example}
  \scalebox{0.6}{\input{img/descriptive/waiting_time_distribution_example}}
  \end{center} 
  \end{frame}
...
\begin{center}
\tikzsetnextfilename{descriptive/bimodal_distribution_example}
\scalebox{0.6}{\input{img/descriptive/bimodal_distribution_example}}
\end{center} 
\end{frame}
...
\framesubtitle{Women's weight}
\begin{center}
\tikzsetnextfilename{weights_distribution_example}
\scalebox{0.6}{\input{img/descriptive/weights_distribution_example}}
\end{center} 
\end{frame}
...
\begin{center}
\tikzsetnextfilename{women_heights_distribution_example}
\scalebox{0.6}{\input{img/descriptive/women_heights_distribution_example}}
\end{center} 
\end{frame}
...
\begin{center}
\tikzsetnextfilename{men_heights_distribution_example}
\scalebox{0.6}{\input{img/descriptive/men_heights_distribution_example}}
\end{center} 
\end{frame}
...
\begin{center}
\tikzsetnextfilename{women_men_heights_distribution_example}
\scalebox{0.6}{\input{img/descriptive/women_men_heights_distribution_example}}
\end{center} 
\end{frame}
...
\begin{center}
\tikzsetnextfilename{heights_distribution_example}
\scalebox{0.6}{\input{img/descriptive/heights_distribution_example}}
\end{center} 
\end{frame}
...
\begin{center}
\tikzsetnextfilename{cholesterol_distribution_example}
\scalebox{0.6}{\input{img/descriptive/cholesterol_distribution_example}}
\end{center} 
\end{frame}  
...
\begin{center}
\tikzsetnextfilename{scores_distribution_example}
\scalebox{0.6}{\input{img/descriptive/scores_distribution_example}}
\end{center} 
\end{frame}  
...
The bell shaped distribution appears so frequently in Nature that is known as the \highlight{Normal distribution} or \highlight{Gaussian distribution}.
\begin{center}
\tikzsetnextfilename{gauss_bell}
\scalebox{0.6}{\input{img/descriptive/gauss_bell}}
\end{center} 
\end{frame}  
...
\begin{frame}
\frametitle{Outliers}
One of the main problems in samples are \highlight{\textbf{outliers}}, values very different from the rest of values of the sample.
\begin{center}
...
\input{img/descriptive/interpolation}
...
\resizebox{0.8\textwidth}{!}{\input{img/descriptive/interpolation_example_1}}
\end{center}
\end{frame}
...
\input{img/descriptive/interpolation_example_2}
...
\scalebox{1}{\input{img/descriptive/std_deviation_interpretation}}
...
\scalebox{0.6}{\input{img/descriptive/symmetrical_distribution}}
\end{center}
\end{frame} 
...
\scalebox{0.6}{\input{img/descriptive/left_skewed_distribution}}
\end{center}
\end{frame} 
...
\scalebox{0.6}{\input{img/descriptive/right_skewed_distribution}}
\end{center}
\end{frame}
...
\scalebox{0.6}{\input{img/descriptive/mesokurtic_distribution}}
\end{center}
\end{frame}
...
\scalebox{0.6}{\input{img/descriptive/platykurtic_distribution}}
\end{center}
\end{frame}
...
\scalebox{0.6}{\input{img/descriptive/leptokurtic_distribution}}
\end{center} 
\end{frame}
...
\scalebox{0.4}{\input{img/descriptive/square_transformation}}
\end{center} 
\end{frame}
...
corresponding to the categories of another variable, known as \highlight{\textbf{classificatory variable}} or
...
\scalebox{0.45}{\input{img/descriptive/factor_histogram}}
\tikzsetnextfilename{descriptive/factor_box_plot}
\scalebox{0.45}{\input{img/descriptive/factor_box_plot}}
\end{center}
\end{frame}
