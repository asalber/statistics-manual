...
\mode<article>{Surely you has not been able to guess the motif becuase the number of pixels picked in the sample is too small to understand the variability of colors in the picture.
