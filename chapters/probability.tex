...
\highlight{Incidence} measures the probability of occurrence of a medical event in a population within a given period of time.
Incidence can be measured as a proportion or as a rate.

\begin{definition}[Incidence proportion]
...
\]
This means that the odds of getting the flu versus not getting the flu in vaccinated individuals is almost one fifth of that in unvaccinated.
\end{frame}
...
The interpretation of the odds ratio is trickier because is counterfactual, and give us how many times is more frequent the event in the treatment group in comarison with the control group, assuming that in the control group the event is as frequent as the non-event.
