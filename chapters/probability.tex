...
\highlight{Incidence} measures the probability of occurrence of a medical condition in a population within a given period of time.
...
\frametitle{Relative risk vs Odds ratio} 
\begin{center}
\tikzsetnextfilename{probability/odd_ratio_vs_relative_risk}
\mode<article>{\resizebox{0.6\textwidth}{!}{\input{img/probability/odd_ratio_vs_relative_risk}}}
\mode<presentation>{\resizebox{!}{\textheight}{\input{img/probability/odd_ratio_vs_relative_risk}}}
\end{center}
\end{frame}
...
\mode<presentation>{\resizebox{\textwidth}{!}{\input{img/probability/likelihood_ratios}}}
\end{center}
\end{frame}
