...
\mode<article>{\resizebox{0.7\textwidth}{!}{\input{img/continuous_random_variables/density_function}}}
\mode<presentation>{\resizebox{0.7\textwidth}{!}{\input{img/continuous_random_variables/density_function}}}
...
\mode<article>{\resizebox{0.6\textwidth}{!}{\input{img/continuous_random_variables/uniform_density_function}}}
\mode<presentation>{\resizebox{0.6\textwidth}{!}{\input{img/continuous_random_variables/uniform_density_function}}}
\end{center}
\end{frame}
...
\mode<article>{\resizebox{0.6\textwidth}{!}{\input{img/continuous_random_variables/uniform_distribution_function}}}
\mode<presentation>{\resizebox{0.6\textwidth}{!}{\input{img/continuous_random_variables/uniform_distribution_function}}}
\end{center}
\end{frame}
...
\mode<article>{\resizebox{0.6\textwidth}{!}{\input{img/continuous_random_variables/uniform_probability_calculation}}}
\mode<presentation>{\resizebox{1\textwidth}{!}{\input{img/continuous_random_variables/uniform_probability_calculation}}}
\end{center}
\end{column}
\end{columns}
...
\mode<presentation>{\resizebox{\textwidth}{!}{\input{img/continuous_random_variables/normal_density_function_different_means}}}
\end{column}
\begin{column}{0.47\textwidth}
\mode<article>{
\tikzsetnextfilename{continuous_random_variables/normal_density_function_different_means}
\resizebox{0.5\textwidth}{!}{\input{img/continuous_random_variables/normal_density_function_different_means}}
\tikzsetnextfilename{continuous_random_variables/normal_density_function_different_variances}
\resizebox{0.5\textwidth}{!}{\input{img/continuous_random_variables/normal_density_function_different_variances}}
}
\mode<presentation>{\resizebox{\textwidth}{!}{\input{img/continuous_random_variables/normal_density_function_different_variances}}}
\end{column}
\end{columns}
\end{frame}
...
\mode<article>{\resizebox{0.6\textwidth}{!}{\input{img/continuous_random_variables/normal_distribution_function}}}
\mode<presentation>{\resizebox{0.6\textwidth}{!}{\input{img/continuous_random_variables/normal_distribution_function}}}
\end{center}
\end{frame}
...
\mode<presentation>{\resizebox{0.5\textwidth}{!}{\input{img/continuous_random_variables/normal_properties1}}}
\end{center}
\end{frame}
...
\mode<article>{\input{img/continuous_random_variables/normal_table}}
\mode<presentation>{\scalebox{0.9}{\input{img/continuous_random_variables/normal_table}}}
...
\mode<article>{\resizebox{0.6\textwidth}{!}{\input{img/continuous_random_variables/chi_square_density_function}}}
\mode<presentation>{\resizebox{0.6\textwidth}{!}{\input{img/continuous_random_variables/chi_square_density_function}}}
\end{center}
\end{frame}
...
\mode<article>{\resizebox{0.6\textwidth}{!}{\input{img/continuous_random_variables/student_t_density_function}}}
\mode<presentation>{\resizebox{0.6\textwidth}{!}{\input{img/continuous_random_variables/student_t_density_function}}}
\end{center}
\end{frame}
...
\mode<article>{\resizebox{0.6\textwidth}{!}{\input{img/continuous_random_variables/fisher_f_density_function}}}
\mode<presentation>{\resizebox{0.6\textwidth}{!}{\input{img/continuous_random_variables/fisher_f_density_function}}}
\end{center}
\end{frame}
