...
\author{
    Javier Conesa Egea (\href{mailto:javier.conesaegea@ceu.es}{javier.conesaegea@ceu.es})\\
    Juan Carlos Garro Garro (\href{mailto:garro.eps@ceu.es}{garro.eps@ceu.es})\\
    Eduardo López Ramírez (\href{mailto:elopez@ceu.es}{elopez@ceu.es})\\
    Rubén Oncala Mesa (\href{mailto:ruben.oncalamesa@ceu.es}{ruben.oncalamesa@ceu.es})\\
    Alfredo Sánchez Alberca (\href{mailto:asalber@ceu.es}{asalber@ceu.es})\\
    Alberto Zaragoza de Lorite (\href{mailto:alberto.zaragozalorite@ceu.es}{alberto.zaragozalorite@ceu.es})
}
\date{September 2023\\[1cm]
...
\institute{Department of Maths and Data Science\\ CEU San Pablo}
\date{September 2023}
