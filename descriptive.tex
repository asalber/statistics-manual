...
Intervals are known as \structure{\textbf{classes}} and the center of intervals as \structure{\textbf{class marks}}.
...
Sometimes a polygon, known as \structure{\textbf{frequency polygon}}, is plotted joining the top of every bar with
straight lines.
\end{frame}
...
\structure{\textbf{Example}} The following samples contains the grades of 2 students in 2 subjects 
\begin{center}
...
\structure{Example} Dividing the sample of heights by gender we get two subsamples
\begin{center}
\begin{tabular}{lll}
\hline
\multirow{2}{*}{Females} &
