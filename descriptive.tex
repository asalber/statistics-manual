...
\structure{Histograma}: Es similar a un diagrama de barras pero
...
\structure{Diagrama de sectores}: Consiste en un círculo dividido
...
\begin{center}
\scalebox{0.5}{\input{img/descriptive/abs_freq_bar_chart}} 
\end{center}
\end{frame}
...
\framesubtitle{Non-grouped data}
\begin{center}
\scalebox{0.5}{\input{img/descriptive/abs_freq_bar_chart_polygon}} 
\end{center}
\end{frame}
