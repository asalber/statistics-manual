...
\item \structure{Frecuencia relativa $f_i$}: Is the proportion of times that value $x_i$ appears in the sample.
\[
f_i = \frac{n_i}{n}
\]
\item \structure{Cumulative absolute frequency $N_i$}: Is the number of values less than or equal to $x_i$ in the
sample.
\[
N_i = n_1 + \cdots + n_i
\]
\item \structure{Cumulative relative frequency $F_i$}: Is the proportion of values less than or equal to $x_i$ in the
sample.
\[
F_i = \frac{N_i}{n}
\]
...
% \begin{center}
% \scalebox{0.75}{\input{img/descriptive/diagrama_barras_frecuencia_absoluta}}
% \end{center}
...
% \framesubtitle{Datos sin agrupar}
% \begin{center}
% \scalebox{0.75}{\input{img/descriptive/poligono_frecuencia_absoluta}}
% \end{center}
...
% \framesubtitle{Datos sin agrupar}
% \begin{center}
% \scalebox{0.75}{\input{img/descriptive/diagrama_barras_frecuencia_acumulada}}
% \end{center}
...
% \framesubtitle{Datos sin agrupar}
% \begin{center}
% \scalebox{0.75}{\input{img/descriptive/poligono_frecuencia_acumulada}}
% \end{center}
...
% \begin{center}
% \scalebox{0.75}{\input{img/descriptive/histograma_frecuencia_absoluta}}
% \end{center}
...
% \framesubtitle{Datos agrupados}
% \begin{center}
% \scalebox{0.75}{\input{img/descriptive/poligono_frecuencia_absoluta_agrupado}}
% \end{center}
...
% \framesubtitle{Datos agrupados}
% \begin{center}
% \scalebox{0.75}{\input{img/descriptive/histograma_frecuencia_acumulada}}
% \end{center}
...
% \framesubtitle{Datos agrupados}
% \begin{center}
% \scalebox{0.75}{\input{img/descriptive/poligono_frecuencia_acumulada_agrupado}}
% \end{center}
...
% \begin{center}
% \includegraphics[scale=0.6]{img/descriptive/diagrama_sectores_grupo_sanguineo}
% \end{center}
...
% \begin{center}
% \includegraphics[scale=0.4]{img/descriptive/dato_atipico}
% \end{center}
% 
...
% \end{itemize}
% \begin{center}
% \includegraphics[scale=0.4]{img/descriptive/mediana}
% \end{center}
...
% \begin{center}
% \includegraphics[scale=0.5]{img/descriptive/moda}
% \end{center}
...
% \begin{center}
% \scalebox{0.75}{\input{img/descriptive/diagrama_caja}}
% \end{center}
...
% \end{enumerate}
% \begin{center}
% \scalebox{0.65}{\input{img/descriptive/diagrama_caja_hijos}}
% \end{center}
...
% \end{center}
% \begin{center}
% \scalebox{0.5}{\input{img/descriptive/histograma_estatura_sexo}}
% \quad
% \scalebox{0.5}{\input{img/descriptive/diagrama_cajas_estatura_sexo}}
% \end{center}
% 
