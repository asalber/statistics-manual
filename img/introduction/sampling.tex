...
\node (population) [label=-90:Population] at (0,0) {\includegraphics[height=1.5cm]{img/introduction/population.pdf}}; 
\node (sample) [label=-90:Sample] at (5,0) {\includegraphics[height=1.5cm]{img/introduction/sample.pdf}};
