...
\node (data) [label=-90:Data] at (0,1) {\includegraphics[height=1.5cm]{img/introduction/data.pdf}}; 
\pause
...
\ STATISTICS\ \phantom{}};
\pause
\node (knowledge) [label=-90:Knowledge] at (9.5,1) {\includegraphics[height=1.5cm]{img/introduction/knowledge.png}};
