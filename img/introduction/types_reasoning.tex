...
\node (population) [label=90:Population] at (0,5) {\includegraphics[height=2cm]{img/introduction/population.pdf}}; 
\node (sample) [label=-90:Sample] at (0,0) {\includegraphics[height=2cm]{img/introduction/sample.png}};
