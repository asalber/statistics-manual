% Created by tikzDevice version 0.9 on 2016-04-28 17:56:34
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at (159.54,118.65) {$\int_5^10 \frac{1}{15}\,dx$};
\end{scope}
\end{tikzpicture}
