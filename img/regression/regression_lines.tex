% Created by tikzDevice version 0.10.1 on 2016-02-24 10:03:51
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.20] at (264.95,332.61) {\bfseries Regression lines of weight and height};
...
\path[draw=drawColor,line width= 0.8pt,line join=round,line cap=round] ( 49.20, 40.84) -- (480.69,257.76);

\path[draw=drawColor,line width= 0.8pt,line join=round,line cap=round] ( 73.20,  0.00) -- (480.69,318.80);
\definecolor{fillColor}{RGB}{238,50,36}

\path[fill=fillColor] (262.31,147.96) circle (  2.25);

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at (248.96,154.64) {$(\bar x, \bar y)$};

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at (424.76,194.05) {Weight on Height};

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at (344.85,264.94) {Height on Weight};
\end{scope}
\end{tikzpicture}
