% Created by tikzDevice version 0.10.1 on 2016-02-27 13:06:07
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.20] at (174.01,222.30) {\bfseries Regression lines of weight and height};
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at (277.12,123.58) {Weight on Height};

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at (225.57,179.98) {Height on Weight};
\end{scope}
\end{tikzpicture}
