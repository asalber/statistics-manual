% Created by tikzDevice version 0.10.1 on 2016-02-27 12:38:36
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.79] at ( 60.22,208.50) {\bfseries No relation};
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.79] at (180.68,208.50) {\bfseries Linear relation};
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.79] at (301.12,208.50) {\bfseries Quadratic relation};
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.79] at ( 60.22,100.09) {\bfseries Exponential relation};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (361.35,216.81);
\definecolor{drawColor}{RGB}{0,0,0}
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.79] at (180.68,100.09) {\bfseries Logarithmic relation};
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  0.79] at (301.12,100.09) {\bfseries Inverse relation};
