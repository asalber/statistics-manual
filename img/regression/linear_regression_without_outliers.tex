...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.20] at (271.01,339.14) {\bfseries Linear regression without outliers};
...
\end{scope}
\end{tikzpicture}
h[clip] ( 72.27, 72.27) rectangle (469.75,325.21);
\definecolor{fillColor}{RGB}{5,161,230}

\path[fill=fillColor] (381.43,269.00) circle (  2.25);
\definecolor{drawColor}{RGB}{0,0,0}

\path[draw=drawColor,line width= 0.8pt,line join=round,line cap=round] ( 72.27,200.25) -- (469.76, 75.35);

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at (271.01,243.08) {\Large $y$= -0.5 x + 4.86};

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at (271.01,226.37) {\Large $r^2$ = 0.99};
\end{scope}
\end{tikzpicture}
