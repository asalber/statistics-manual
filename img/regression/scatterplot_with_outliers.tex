% Created by tikzDevice version 0.10.1 on 2016-02-27 13:47:46
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.20] at (174.01,222.30) {\bfseries Scatter plot with outliers};
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.00] at (225.57,171.12) {Outlier};
\end{scope}
\end{tikzpicture}
