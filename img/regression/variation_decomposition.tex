...
\node[anchor=west, visible on=<3->] at ( 46.42,135.40) {Total variation};
\node[anchor=west, visible on=<3->] at ( 46.42,122.94) {$y_j-\bar y$};
% Regression line 
\draw[line width= 0.8pt, visible on=<4->] ( 34.80,  6.74) -- (313.21,194.30);
\node[anchor=base, visible on=<4->] at (256.03,185.62) {Regression line of};
\node[anchor=base, visible on=<4->] at (256.03,176.37) {$Y$ on $X$};
% Prediction
\draw[dotted, gray, visible on=<5->] (0.00,117.89) -- (199.79,117.89);
 
\draw[<->, color2, visible on=<6->] (199.79, 92.31) -- (199.79,117.89);
\node[anchor=base west, visible on=<6->] at (212.47,107.84) {Explained variation};
\node[anchor=base west, visible on=<6->] at (212.47, 97.38) {$f(x_i)-\bar y$};

\draw[<->, color2, visible on=<7->] (199.79,117.89) -- (199.79,162.72);
\node[anchor=base east, visible on=<7->] at (192.47,146.32) {Non-explained};
\node[anchor=base east, visible on=<7->] at (192.47,137.86) {variation};
\node[anchor=base east, visible on=<7->] at (192.47,128.40) {$e_{ij}=y_j-f(x_i)$};
\end{scope}
\end{tikzpicture}
