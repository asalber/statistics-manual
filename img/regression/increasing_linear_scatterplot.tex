...
\path[fill=fillColor] (316.69,231.93) circle (  2.25);

\path[fill=fillColor] (447.26,271.48) circle (  2.25);

\path[fill=fillColor] ( 94.27, 91.02) circle (  2.25);

\path[fill=fillColor] (263.73,218.99) circle (  2.25);

\path[fill=fillColor] (266.74,156.11) circle (  2.25);

\path[fill=fillColor] (137.82,119.33) circle (  2.25);

\path[fill=fillColor] (190.53,156.53) circle (  2.25);

\path[fill=fillColor] (299.31,236.82) circle (  2.25);

\path[fill=fillColor] (126.85,124.30) circle (  2.25);

\path[fill=fillColor] (246.89,178.67) circle (  2.25);

\path[fill=fillColor] (314.48,196.95) circle (  2.25);

\path[fill=fillColor] (306.60,236.18) circle (  2.25);

\path[fill=fillColor] ( 77.41, 72.40) circle (  2.25);

\path[fill=fillColor] (177.11,172.20) circle (  2.25);

\path[fill=fillColor] (222.17,187.53) circle (  2.25);

\path[fill=fillColor] (357.01,227.22) circle (  2.25);

\path[fill=fillColor] (411.08,249.71) circle (  2.25);

\path[fill=fillColor] (372.78,242.62) circle (  2.25);

\path[fill=fillColor] (433.29,271.08) circle (  2.25);

\path[fill=fillColor] (153.17,135.42) circle (  2.25);

\path[fill=fillColor] (451.16,282.47) circle (  2.25);

\path[fill=fillColor] (251.29,169.50) circle (  2.25);

\path[fill=fillColor] (152.86,140.99) circle (  2.25);

\path[fill=fillColor] (170.74,165.73) circle (  2.25);

\path[fill=fillColor] (287.13,187.31) circle (  2.25);

\path[fill=fillColor] (265.69,184.50) circle (  2.25);

\path[fill=fillColor] (359.02,241.51) circle (  2.25);

\path[fill=fillColor] (453.45,275.26) circle (  2.25);

\path[fill=fillColor] (289.98,203.53) circle (  2.25);

\path[fill=fillColor] (252.26,224.07) circle (  2.25);

\path[fill=fillColor] (329.03,239.32) circle (  2.25);

\path[fill=fillColor] (176.81,144.21) circle (  2.25);

\path[fill=fillColor] (425.34,276.63) circle (  2.25);

\path[fill=fillColor] (257.48,175.29) circle (  2.25);
\end{scope}
\begin{scope}
...
\path[draw=drawColor,line width= 0.4pt,dash pattern=on 4pt off 4pt ,line join=round,line cap=round] ( 36.13,186.07) -- (469.75,186.07);

\path[draw=drawColor,line width= 0.4pt,dash pattern=on 4pt off 4pt ,line join=round,line cap=round] (253.18, 36.13) --
(253.18,325.22);
\end{scope}
\end{tikzpicture}
