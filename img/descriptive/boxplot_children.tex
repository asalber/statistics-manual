...
\definecolor{drawColor}{RGB}{0,0,0}
\uncover<2->{\path[draw=drawColor,line width= 1.2pt,line join=round] 
	(165.06,140.20) --
	(165.06,233.15);
}
\uncover<3->{\path[draw=drawColor,line width= 1.2pt,line join=round] (264.94,140.20) -- (264.94,233.15);
}

\uncover<6->{\path[draw=drawColor,line width= 0.4pt,dash pattern=on 4pt off 4pt ,line join=round,line cap=round] ( 65.18,186.67) -- (165.06,186.67);
\path[draw=drawColor,line width= 0.4pt,line join=round,line cap=round] ( 65.18,163.44) -- ( 65.18,209.91);
}


\uncover<7->{\path[draw=drawColor,line width= 0.4pt,dash pattern=on 4pt off 4pt ,line join=round,line cap=round] (364.83,186.67) -- (264.94,186.67);
