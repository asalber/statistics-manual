...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.20] at (264.94,332.61) {\bfseries Distribution of age dead of australian males};
...
\node[text=drawColor,an0.4pt,line join=round,line cap=round,fill=fillColor] (379.10, 70.49) rectangle (388.61, 96.63);
...
\end{scope}
\end{tikzpicture}
=0pt, scale=  1.00] at (304.90, 39.60) {60};
