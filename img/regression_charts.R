...
n = 100
tikz(file="img/regression/different_correlations", width=7, height=5)
par(mfrow=c(3,3))
...
tikz(file="img/regression/linear_regression_parabolic_relation.tex", width=7, height=5)
...
text(5,6.5,paste("\\Large $r^2$ =",floor(summary(model)$r.squared*100)/100))
dev.off()


# Parabolic regression
tikz(file="img/regression/parabolic_regression.tex", width=7, height=5)
par(mai=c(1,1,0.5,0.5), cex.lab=1.2)
plot(y~x, col =color1, xlab="$X$", ylab="$Y$", pch=16)
model <- lm(y~x+I(x^2))
...
tikz(file="img/regression/linear_regression_without_outliers.tex", width=7, height=5)
par(mai=c(1,1,0.5,0.5), cex.lab=1.2)
...
x=c(x,8)
y=c(y,8)
tikz(file="img/regression/linear_regression_with_outliers.tex", width=7, height=5)
par(mai=c(1,1,0.5,0.5), cex.lab=1.2)
...
tikz(file="img/regression/scatterplot_with_outliers.tex", width=7, height=5)
par(mai=c(1,1,0.5,0.5), cex.lab=1.2)
plot(y~x, col =color1, main="Linear regression with outliers", xlim=c(0,10), ylim=c(0,10), xlab="$X$", ylab="$Y$", pch=16)
dev.off()
