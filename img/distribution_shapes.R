...
hist(data, main="USA househod income dristribution", breaks=breaks, xaxt="n", xlab="Yearly income (thousand dollars)", ylab="Relative frequency", col="orange", prob=T)
...
hist(data, main="Distribution of age dead of australian males",  xlab="Age of dead", ylab="Relative frequency", breaks = breaks, xaxt="n", col="orange", prob=T)
...
data <- rep(breaks, counts)
breaks <- seq(8,24)
hist(data, main="Distribution of clients arrival times in a restaurant",  xlab="Time", ylab="Relative frequency", breaks = breaks, xaxt="n", col="orange", prob=T)
axis(side=1, at=breaks, labels=breaks)
dev.off()