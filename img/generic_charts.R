...
png(file = "img/descriptive/bar_chart.png", bg = "transparent", width=4, height=3)
barplot(tab,space=0.5, col="coral", xaxt='n', yaxt='n',xaxt='n', yaxt='n', xlab=expression(italic(X)),ylab="Frequency",axes=FALSE)
Axis(side=1, labels=FALSE)
Axis(side=2, labels=FALSE)
dev.off()

png(file = "img/descriptive/polygon.png", bg = "transparent", width=4, height=3)
...
hist(x,xlim=c(-3.5,3.5),breaks=50, ylim=c(0,0.4), xaxt="n", prob=T, main="Symmetrical distribution $g1=0$", xlab ="", ylab="Relative frequency", col="coral")
...
layout(matrix(c(1,2),2,1),heights=c(3,1))
par(mai=c(0,1,0.5,0),cex.lab=1.2)
hist(-x, xaxt="n", breaks=700, xlim=c(-5,0), prob=T, main="Left-skewed distribution $g_1<0$", ylab="Relative frequency", col="coral")
axis(1,at=c(-m,-me),labels=c("$\\bar x$","$Me$"))
par(mai=c(0,1,0,0))
boxplot(-x, horizontal=TRUE, ylim=c(-5,0), axes=FALSE, outline=FALSE, col="coral")
dev.off()
...
layout(matrix(c(1,2),2,1),heights=c(3,1))
par(mai=c(0,1,0.5,0),cex.lab=1.2)
hist(x, xaxt="n", breaks=700, xlim=c(0,5), prob=T, main="Left-skewed distribution $g_1>0$", ylab="Relative frequency", col="coral")
axis(1,at=c(m,me),labels=c("$\\bar x$","$Me$"))
par(mai=c(0,1,0,0))
boxplot(x, horizontal=TRUE, ylim=c(0,5), axes=FALSE, outline=FALSE, col="coral")
dev.off()
...
hist(x,xlim=c(-3.5,3.5), breaks=50, ylim=c(0,0.4),prob=T, main="Mesokurtic distribution $g_2=0$" , xlab ="", ylab="Relative frequency", col="coral", axes=F)
...
par(cex.lab=1.2)
hist(x, prob=T, breaks=50, ylim=c(0,0.2), main="Platykurtic distribution $g_2<0$", xlab ="", ylab="Relative frequency", col="coral", axes=F)
axis(1,at=m,labels="$\\bar x$")
axis(2)
f <- function (z){return(dnorm(z,mean=0,sd=2.5))}
curve(f, add=TRUE, col="royalblue", lwd=2)
dev.off()
...
par(cex.lab=1.2)
hist(x, prob=T, breaks=seq(-100,100,by=0.2), xlim=c(-4.1,4.1), ylim=c(0,0.4), main="Leptokurtic distribution $g_2>0$", xlab ="", ylab="Relative frequency", col="coral", axes=F)
axis(1,at=m,labels="$\\bar x$")
axis(2)
...
par(mai=c(0,0,0,0))
hist(x, xaxt="n", breaks=seq(0,max(x)+1,by=0.14), xlim=c(0,5), prob=TRUE, main="", col="coral", axes=FALSE)
dev.off()
...
par(mai=c(0,0,0,0))
hist(x, breaks=seq(min(x),max(x)+1,by=0.2), xlim=c(-3.5,3.5), ylim=c(0,0.4), prob=TRUE, main="", col="coral", axes=FALSE)
dev.off()
